...
def main(_argv):
    ...
    myCascade = cv2.CascadeClassifier("uavpayloadtaq_cascadeclassifier.xml")
    ...
    try:
        while True:
            ...
            #images_data = []
            grey = cv2.cvtColor(image_data, cv2.COLOR_BGR2GRAY)
            ...
            results = face_cascade.detectMultiScale(grey, 1.3, 5)
